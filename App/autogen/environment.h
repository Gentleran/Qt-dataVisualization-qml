...
Q_IMPORT_QML_PLUGIN(MotolControlQmlPlugin)
Q_IMPORT_QML_PLUGIN(MotolControlQmlContentPlugin)

const char mainQmlFile[] = "qrc:/qt/qml/MotolControlQmlContent/App.qml";
